class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.24/cli-16.3.24.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "ca0cedc8646babbd8b72d4171ca19d770418d214d35ae2a923987c0f18152c0c"
  version "16.3.24"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.24.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.3.24.jar" "$@"
    EOS
  end
