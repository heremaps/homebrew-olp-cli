class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.42/cli-16.3.42.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "2ea483a5f042ffef1173f4e5b1d1e5467ab2447cb43a1caa9e80c1a524d71fb1"
  version "16.3.42"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.42.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.3.42.jar" "$@"
    EOS
  end
