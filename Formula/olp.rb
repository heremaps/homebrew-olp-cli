class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.75/cli-16.3.75.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "10e40859d955bea7eb1cf4718ede74e06f4d3fb19950fe0b0483467027addfef"
  version "16.3.75"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.75.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.3.75.jar" "$@"
    EOS
  end
