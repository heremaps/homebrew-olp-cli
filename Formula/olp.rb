class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.10/cli-16.3.10.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "6e16578208b8bcbc38f7594c24bec572c46bc3b19cacf24ad1912b97a38c086f"
  version "16.3.10"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.10.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.3.10.jar" "$@"
    EOS
  end
