class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.5/cli-16.3.5.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "e1eadb240c6cb88197e6bb1df0d0539be47a74d057eebd2ed2cd207dcdb68f14"
  version "16.3.5"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.5.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.3.5.jar" "$@"
    EOS
  end
