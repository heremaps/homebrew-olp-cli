class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:12.3.13/cli-12.3.13.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "6d1a17dc0d54d3431c320a2bb86572d7834c5832951efd2cb89f8aa0c1e6199a"
  version "12.3.13"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-12.3.13.jar"
