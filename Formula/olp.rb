class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.2.39/cli-16.2.39.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "778829082fbd6c67d762a500613a8a60fef68fa117835f393c51db88904ef4fa"
  version "16.2.39"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.2.39.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-16.2.39.jar" "$@"
    EOS
  end
