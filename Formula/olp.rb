class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:14.0.19/cli-14.0.19.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "b301f131b376e2baab134122d0a9b0ee8bae0b9470a2e5983ccd341727145c06"
  version "14.0.19"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-14.0.19.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-14.0.19.jar" "$@"
    EOS
  end
