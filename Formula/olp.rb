class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:12.3.26/cli-12.3.26.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "b400857bb985b50e9946a4574ae569fae984ffdf607f3998ce2641df20198348"
  version "12.3.26"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-12.3.26.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-12.3.26.jar" "$@"
    EOS
  end
