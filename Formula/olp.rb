class Olp < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:14.0.9/cli-14.0.9.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "a48f5c5d55268db485c100984092bac6be00c5db8517e4d59944e109a6aa83a0"
  version "14.0.9"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-14.0.9.jar"
    ...
    (bin/"olp").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -jar "#{libexec}/cli_2.12-14.0.9.jar" "$@"
    EOS
  end
